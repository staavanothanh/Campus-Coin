...
VALUES (2, 1, 'payment', 1, 5, '2026-09-02 00:00:00.000', 'original', 4);

-- Correction hợp lệ: role <> original có reference + reason + amount dương.
INSERT INTO ledger_transactions (id, user_id, type, amount_vnd, category_id, occurred_at, role, reference_id, reason, idempotency_id)
VALUES (3, 1, 'payment', 1, 5, '2026-09-01 00:00:00.000', 'reversal', 2, 'hoàn tiền mẫu', 5);
...
VALUES (1, 5, '2026-09', 250000, 18) AS new
ON DUPLICATE KEY UPDATE limit_vnd = new.limit_vnd, idempotency_id = new.idempotency_id;
