...
import { isCategoryStatus, isTransactionType, type CategoryStatus, type TransactionType } from "../domain/money.js";
import { invalidInput, notFound } from "../domain/errors.js";
import { toCategory, type CategoryView } from "./map.js";
